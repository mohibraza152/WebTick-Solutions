...
feedbackForm.addEventListener("submit", function (event) {
  ...
  const params = {
    fb_name: name,
    fb_email: email,
    fb_rating: starsVisual,
    fb_message: message
  };

  // -------- Send Email --------
  emailjs
    .send("service_eexjjk6", "template_fgxctrn", params)
    .then(() => {
...
function submitProductForm() {
  ...
  // Button disable karo taake double submit na ho
  ...
  emailjs.send("service_eexjjk6", "template_zkz61o4", params)
    .then(() => {
      alert("You're all set! We'll be in touch with you shortly. 🎉");
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "select",
        options: ["WhatsApp", "Instagram", "Facebook", "Website", "Email", "SMS", "Other"]
      }
    ]
  }
];
...
const aiContextFields = {
  ...
  gmail: [
    ...
    { label: "Sample Email (optional)", id: "sampleEmail", type: "textarea" }
  ],
  excel: [
...
const productFields = {
  ...
  chatbot: {
    basic: [
      { label: "Chatbot Purpose", id: "botPurpose", type: "select", options: ["Lead Generation", "Customer Support", "Booking Automation", "Sales", "General", "Other"] },
      { label: "Website URL", id: "websiteURL", type: "text" },
      { label: "Languages Needed", id: "languages", type: "select", options: ["English", "Urdu", "Spanish", "Arabic", "Chinese","Other"] }
    ],

    standard: [
      { label: "Integrations Needed", id: "integrations", type: "select", options: ["Booking API", "CRM", "Payment Gateway", "Custom API", "Other"] },
      { label: "Brand Style", id: "branding", type: "select", options: ["Minimal", "Corporate", "Modern", "Colorful", "Other"] },
      { label: "Website URL", id: "websiteURL", type: "text" }
    ],
  ...
  gmail: {
    basic: [
      { label: "Email Type", id: "emailType", type: "select", options: ["Cold Email", "Follow-up", "Nurturing", "Sales", "Other"] },
    ...
    standard: [
      ...
      { label: "CRM Used", id: "crm", type: "select", options: ["GoHighLevel", "HubSpot", "Zoho", "Other", "None"] }
    ],

    premium: [
      { label: "Personalization Data Source", id: "dataSource", type: "select", options: ["Google Sheet", "CRM", "API", "Manual", "Other"] },
  ...
  excel: {
    basic: [
      { label: "Sheet Type", id: "sheetType", type: "select", options: ["Expense Sheet", "Employee Sheet", "Sales Report", "Inventory Sheet", "Other"] },
  ...
  automation: {
    basic: [
      { label: "Automation Type", id: "automationType", type: "select", options: ["Reminder", "Welcome Flow", "Lead Nurture", "Follow Up", "Other"] },
      { label: "Audience Size", id: "audienceSize", type: "number" }
    ],

    standard: [
      { label: "Channels Needed", id: "channels", type: "select", options: ["Email", "SMS", "WhatsApp", "Facebook", "Instagram", "Other"] },
      { label: "Trigger Types", id: "triggers", type: "select", options: ["New Lead", "Form Filled", "Order Placed", "Abandoned Cart", "Other"] }
    ],
